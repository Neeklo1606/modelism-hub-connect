...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "МоДелизМ Club — сообщество моделистов" },
      ...
      { property: "og:title", content: "МоДелизМ Club — сообщество моделистов" },
      { name: "twitter:title", content: "МоДелизМ Club — сообщество моделистов" },
